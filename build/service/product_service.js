...
var createNewProduct = function createNewProduct(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(resolve, reject) {
      var _yield$db$Product$fin, _yield$db$Product$fin2, object, created;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            _yield$db$Product$fin2 = _slicedToArray(_yield$db$Product$fin, 2);
            object = _yield$db$Product$fin2[0];
            created = _yield$db$Product$fin2[1];
            if (!created) {
              resolve({
