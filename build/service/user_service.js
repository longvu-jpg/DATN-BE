...
var _email_service = require("../service/email_service");
...
var createNewUser = function createNewUser(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
      var salt, password, code, _yield$db$User$findOr, _yield$db$User$findOr2, user, created;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            break;
          case 5:
            salt = (0, _bcrypt.genSaltSync)(10);
            password = (0, _bcrypt.hashSync)(data.password, salt);
            code = (0, _email_service.generateDigitCode)();
            console.log("aaa");
            _context.next = 11;
          ...
          case 11:
            ...
            if (!created) {
              ...
              (0, _email_service.sendMail)(user.email, code);
              resolve({
                statusCode: 200,
...
var getDetailUser = function getDetailUser(id) {
  return new Promise( /*#__PURE__*/function () {
        ...
        while (1) switch (_context4.prev = _context4.next) {
          ...
          case 7:
            ...
            if (!user) {
              ...
              resultCompare = (0, _bcrypt.compareSync)(data.password, user.password);
              if (!resultCompare) {
                resolve({
              ...
              var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(user) {
                return _regeneratorRuntime().wrap(function _callee7$(_context7) {
                  while (1) switch (_context7.prev = _context7.next) {
                    ...
                    case 2:
                      (0, _email_service.sendMail)(user.email, user.verify_code);
                      resolve({
                        statusCode: 200,
...
var resetPassword = function resetPassword(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(resovle, reject) {
